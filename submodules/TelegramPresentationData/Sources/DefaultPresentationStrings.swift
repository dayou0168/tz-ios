...
public let defaultPresentationStrings = PresentationStrings(primaryComponent: PresentationStrings.Component(languageCode: "zh-hans", localizedName: "简体中文", pluralizationRulesCode: "zh", dict: NSDictionary(contentsOf: URL(fileURLWithPath: getAppBundle().path(forResource: "Localizable", ofType: "strings", inDirectory: nil, forLocalization: "zh-Hans")!)) as! [String : String]), secondaryComponent: nil, groupingSeparator: "")
