#!/usr/bin/env python3
"""Fail closed unless the checkout is the auditable TZ iOS 1.0.9 variant."""
...
def main() -> int:
    ...
    require(versions.get("app") == "1.0.9", "TZ app version must be 1.0.9")
    require(identities.get("bundle_root") == EXPECTED_BUNDLE_ID, "bundle root mismatch")
    require(identities.get("app_group") == EXPECTED_APP_GROUP, "App Group mismatch")
    ...
    require("applinks:tg.tianze8.cc" in build, "TZ associated domain is missing")
    ...
    print("TZ iOS source verification passed: 1.0.9, Chinese default, TZ branding, public links, explicit login password, gramsrv network/RSA")
    return 0
